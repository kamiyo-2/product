...
class ProdutsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create produt" do
    assert_difference('Produt.count') do
      post produts_url, params: { produt: { name: @produt.name, price: @produt.price, vendor: @produt.vendor } }
    end
  ...
  test "should update produt" do
    patch produt_url(@produt), params: { produt: { name: @produt.name, price: @produt.price, vendor: @produt.vendor } }
